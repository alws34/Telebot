...
{
    // Token: 0x0600046A RID: 1130 RVA: 0x0002A658 File Offset: 0x00028858
    public bool IS_F_DEFINED(float _f)
    {
        return _f > 0f;
    }

    // Token: 0x0600046B RID: 1131 RVA: 0x0002A678 File Offset: 0x00028878
    public bool IS_F_DEFINED(double _f)
    {
        return _f > 0.0;
    }

    // Token: 0x0600046C RID: 1132 RVA: 0x0002A69C File Offset: 0x0002889C
    public bool IS_I_DEFINED(int _i)
    {
        return _i != CPUIDSDK.I_UNDEFINED_VALUE;
    }

    // Token: 0x0600046D RID: 1133 RVA: 0x0002A6BC File Offset: 0x000288BC
    public bool IS_I_DEFINED(uint _i)
    {
        return _i != (uint)CPUIDSDK.I_UNDEFINED_VALUE;
    }

    // Token: 0x0600046E RID: 1134 RVA: 0x0002A6DC File Offset: 0x000288DC
    public bool IS_I_DEFINED(short _i)
    {
        return _i != (short)CPUIDSDK.I_UNDEFINED_VALUE;
    }

    // Token: 0x0600046F RID: 1135 RVA: 0x0002A6FC File Offset: 0x000288FC
    public bool IS_I_DEFINED(ushort _i)
    {
        return _i != (ushort)CPUIDSDK.I_UNDEFINED_VALUE;
    }

    // Token: 0x06000470 RID: 1136 RVA: 0x0002A71C File Offset: 0x0002891C
    public bool IS_I_DEFINED(sbyte _i)
    {
        return _i != (sbyte)CPUIDSDK.I_UNDEFINED_VALUE;
    }

    // Token: 0x06000471 RID: 1137 RVA: 0x0002A73C File Offset: 0x0002893C
    ...
    public void LoadDriver()
    {
        ...
        {
            bool flag = manifestResourceNames[i].Replace('\\', '.') == "CAM.Hardware.DLLs.cpuidsdk64.dll";
            if (flag)
            {
        ...
        if (!flag2)
        {
            try
            {
                using (FileStream fileStream = new FileStream(AppDomain.CurrentDomain.BaseDirectory + "cpuidsdk64.dll", FileMode.Create))
                {
    ...
    // Token: 0x06000477 RID: 1143 RVA: 0x0002A8A8 File Offset: 0x00028AA8
    public bool InitSDK(ref int num, ref int num2)
    {
    ...
    public bool InitSDKWithoutHDD(ref int num, ref int num2)
    {
        this.CPUIDSDK_fp_QueryInterface = (CPUIDSDK.CPUIDSDKfpQueryInterface)Marshal.GetDelegateForFunctionPointer(CPUIDSDK.GetProcAddress(this._dllHandle, "QueryInterface"), typeof(CPUIDSDK.CPUIDSDKfpQueryInterface));
        this.CreateInstance();
    ...
    // Token: 0x0600047B RID: 1147 RVA: 0x0002A9C8 File Offset: 0x00028BC8
    ...
    // Token: 0x0600047C RID: 1148 RVA: 0x0002AA50 File Offset: 0x00028C50
    ...
    // Token: 0x0600047D RID: 1149 RVA: 0x0002AB3C File Offset: 0x00028D3C
    ...
    // Token: 0x0600047E RID: 1150 RVA: 0x0002AC18 File Offset: 0x00028E18
    ...
    // Token: 0x0600047F RID: 1151 RVA: 0x0002AD98 File Offset: 0x00028F98
    ...
    // Token: 0x06000480 RID: 1152 RVA: 0x0002ADE8 File Offset: 0x00028FE8
    ...
    // Token: 0x06000481 RID: 1153 RVA: 0x0002AF38 File Offset: 0x00029138
    ...
    // Token: 0x06000482 RID: 1154 RVA: 0x0002B0E0 File Offset: 0x000292E0
    ...
    // Token: 0x06000483 RID: 1155 RVA: 0x0002BC4C File Offset: 0x00029E4C
    ...
    // Token: 0x06000484 RID: 1156 RVA: 0x0002BD54 File Offset: 0x00029F54
    ...
    // Token: 0x06000485 RID: 1157 RVA: 0x0002BDF8 File Offset: 0x00029FF8
    ...
    // Token: 0x06000486 RID: 1158 RVA: 0x0002BE64 File Offset: 0x0002A064
    ...
    // Token: 0x06000487 RID: 1159 RVA: 0x0002BF0C File Offset: 0x0002A10C
    public void Close()
    {
        try
        {
    ...
    // Token: 0x06000488 RID: 1160 RVA: 0x0002BF78 File Offset: 0x0002A178
    ...
    // Token: 0x06000489 RID: 1161 RVA: 0x0002BFE4 File Offset: 0x0002A1E4
    ...
    // Token: 0x0600048A RID: 1162 RVA: 0x0002C054 File Offset: 0x0002A254
    ...
    // Token: 0x0600048B RID: 1163 RVA: 0x0002C0CC File Offset: 0x0002A2CC
    ...
    // Token: 0x0600048C RID: 1164 RVA: 0x0002C148 File Offset: 0x0002A348
    ...
    // Token: 0x0600048D RID: 1165 RVA: 0x0002C1C4 File Offset: 0x0002A3C4
    ...
    // Token: 0x0600048E RID: 1166 RVA: 0x0002C240 File Offset: 0x0002A440
    ...
    // Token: 0x0600048F RID: 1167 RVA: 0x0002C2BC File Offset: 0x0002A4BC
    ...
    // Token: 0x06000490 RID: 1168 RVA: 0x0002C334 File Offset: 0x0002A534
    ...
    // Token: 0x06000491 RID: 1169 RVA: 0x0002C3BC File Offset: 0x0002A5BC
    ...
    // Token: 0x06000492 RID: 1170 RVA: 0x0002C444 File Offset: 0x0002A644
    ...
    // Token: 0x06000493 RID: 1171 RVA: 0x0002C4C0 File Offset: 0x0002A6C0
    ...
    // Token: 0x06000494 RID: 1172 RVA: 0x0002C548 File Offset: 0x0002A748
    ...
    // Token: 0x06000495 RID: 1173 RVA: 0x0002C5D0 File Offset: 0x0002A7D0
    ...
    // Token: 0x06000496 RID: 1174 RVA: 0x0002C64C File Offset: 0x0002A84C
    ...
    // Token: 0x06000497 RID: 1175 RVA: 0x0002C6C8 File Offset: 0x0002A8C8
    ...
    // Token: 0x06000498 RID: 1176 RVA: 0x0002C750 File Offset: 0x0002A950
    ...
    // Token: 0x06000499 RID: 1177 RVA: 0x0002C7CC File Offset: 0x0002A9CC
    ...
    // Token: 0x0600049A RID: 1178 RVA: 0x0002C848 File Offset: 0x0002AA48
    ...
    // Token: 0x0600049B RID: 1179 RVA: 0x0002C8C4 File Offset: 0x0002AAC4
    ...
    // Token: 0x0600049C RID: 1180 RVA: 0x0002C940 File Offset: 0x0002AB40
    ...
    // Token: 0x0600049D RID: 1181 RVA: 0x0002C9BC File Offset: 0x0002ABBC
    ...
    // Token: 0x0600049E RID: 1182 RVA: 0x0002CA38 File Offset: 0x0002AC38
    ...
    // Token: 0x0600049F RID: 1183 RVA: 0x0002CAB4 File Offset: 0x0002ACB4
    ...
    // Token: 0x060004A0 RID: 1184 RVA: 0x0002CB28 File Offset: 0x0002AD28
    ...
    // Token: 0x060004A1 RID: 1185 RVA: 0x0002CB9C File Offset: 0x0002AD9C
    ...
    // Token: 0x060004A2 RID: 1186 RVA: 0x0002CC10 File Offset: 0x0002AE10
    ...
    // Token: 0x060004A3 RID: 1187 RVA: 0x0002CC8C File Offset: 0x0002AE8C
    ...
    // Token: 0x060004A4 RID: 1188 RVA: 0x0002CD04 File Offset: 0x0002AF04
    ...
    // Token: 0x060004A5 RID: 1189 RVA: 0x0002CD7C File Offset: 0x0002AF7C
    ...
    // Token: 0x060004A6 RID: 1190 RVA: 0x0002CDF8 File Offset: 0x0002AFF8
    ...
    // Token: 0x060004A7 RID: 1191 RVA: 0x0002CE70 File Offset: 0x0002B070
    ...
    // Token: 0x060004A8 RID: 1192 RVA: 0x0002CEEC File Offset: 0x0002B0EC
    ...
    // Token: 0x060004A9 RID: 1193 RVA: 0x0002CF64 File Offset: 0x0002B164
    ...
    // Token: 0x060004AA RID: 1194 RVA: 0x0002CFDC File Offset: 0x0002B1DC
    ...
    // Token: 0x060004AB RID: 1195 RVA: 0x0002D054 File Offset: 0x0002B254
    ...
    // Token: 0x060004AC RID: 1196 RVA: 0x0002D0CC File Offset: 0x0002B2CC
    ...
    // Token: 0x060004AD RID: 1197 RVA: 0x0002D144 File Offset: 0x0002B344
    ...
    // Token: 0x060004AE RID: 1198 RVA: 0x0002D1CC File Offset: 0x0002B3CC
    ...
    // Token: 0x060004AF RID: 1199 RVA: 0x0002D254 File Offset: 0x0002B454
    ...
    // Token: 0x060004B0 RID: 1200 RVA: 0x0002D2DC File Offset: 0x0002B4DC
    ...
    // Token: 0x060004B1 RID: 1201 RVA: 0x0002D364 File Offset: 0x0002B564
    ...
    // Token: 0x060004B2 RID: 1202 RVA: 0x0002D3EC File Offset: 0x0002B5EC
    ...
    // Token: 0x060004B3 RID: 1203 RVA: 0x0002D474 File Offset: 0x0002B674
    ...
    // Token: 0x060004B4 RID: 1204 RVA: 0x0002D4E0 File Offset: 0x0002B6E0
    ...
    // Token: 0x060004B5 RID: 1205 RVA: 0x0002D554 File Offset: 0x0002B754
    ...
    // Token: 0x060004B6 RID: 1206 RVA: 0x0002D5DC File Offset: 0x0002B7DC
    ...
    // Token: 0x060004B7 RID: 1207 RVA: 0x0002D664 File Offset: 0x0002B864
    ...
    // Token: 0x060004B8 RID: 1208 RVA: 0x0002D6EC File Offset: 0x0002B8EC
    ...
    // Token: 0x060004B9 RID: 1209 RVA: 0x0002D774 File Offset: 0x0002B974
    ...
    // Token: 0x060004BA RID: 1210 RVA: 0x0002D7FC File Offset: 0x0002B9FC
    ...
    // Token: 0x060004BB RID: 1211 RVA: 0x0002D884 File Offset: 0x0002BA84
    ...
    // Token: 0x060004BC RID: 1212 RVA: 0x0002D90C File Offset: 0x0002BB0C
    ...
    // Token: 0x060004BD RID: 1213 RVA: 0x0002D994 File Offset: 0x0002BB94
    ...
    // Token: 0x060004BE RID: 1214 RVA: 0x0002DA1C File Offset: 0x0002BC1C
    ...
    // Token: 0x060004BF RID: 1215 RVA: 0x0002DAA4 File Offset: 0x0002BCA4
    ...
    // Token: 0x060004C0 RID: 1216 RVA: 0x0002DB2C File Offset: 0x0002BD2C
    ...
    // Token: 0x060004C1 RID: 1217 RVA: 0x0002DBB4 File Offset: 0x0002BDB4
    ...
    // Token: 0x060004C2 RID: 1218 RVA: 0x0002DC3C File Offset: 0x0002BE3C
    ...
    // Token: 0x060004C3 RID: 1219 RVA: 0x0002DCC4 File Offset: 0x0002BEC4
    ...
    // Token: 0x060004C4 RID: 1220 RVA: 0x0002DD4C File Offset: 0x0002BF4C
    ...
    // Token: 0x060004C5 RID: 1221 RVA: 0x0002DE24 File Offset: 0x0002C024
    ...
    // Token: 0x060004C6 RID: 1222 RVA: 0x0002DE9C File Offset: 0x0002C09C
    ...
    // Token: 0x060004C7 RID: 1223 RVA: 0x0002DF40 File Offset: 0x0002C140
    ...
    // Token: 0x060004C8 RID: 1224 RVA: 0x0002E000 File Offset: 0x0002C200
    ...
    // Token: 0x060004C9 RID: 1225 RVA: 0x0002E078 File Offset: 0x0002C278
    ...
    // Token: 0x060004CA RID: 1226 RVA: 0x0002E0C0 File Offset: 0x0002C2C0
    ...
    // Token: 0x060004CB RID: 1227 RVA: 0x0002E118 File Offset: 0x0002C318
    ...
    // Token: 0x060004CC RID: 1228 RVA: 0x0002E170 File Offset: 0x0002C370
    ...
    // Token: 0x060004CD RID: 1229 RVA: 0x0002E1E8 File Offset: 0x0002C3E8
    ...
    // Token: 0x060004CE RID: 1230 RVA: 0x0002E264 File Offset: 0x0002C464
    ...
    // Token: 0x060004CF RID: 1231 RVA: 0x0002E2E0 File Offset: 0x0002C4E0
    ...
    // Token: 0x060004D0 RID: 1232 RVA: 0x0002E368 File Offset: 0x0002C568
    ...
    // Token: 0x060004D1 RID: 1233 RVA: 0x0002E3F0 File Offset: 0x0002C5F0
    ...
    // Token: 0x060004D2 RID: 1234 RVA: 0x0002E478 File Offset: 0x0002C678
    ...
    // Token: 0x060004D3 RID: 1235 RVA: 0x0002E4F4 File Offset: 0x0002C6F4
    ...
    // Token: 0x060004D4 RID: 1236 RVA: 0x0002E57C File Offset: 0x0002C77C
    ...
    // Token: 0x060004D5 RID: 1237 RVA: 0x0002E604 File Offset: 0x0002C804
    ...
    // Token: 0x060004D6 RID: 1238 RVA: 0x0002E68C File Offset: 0x0002C88C
    ...
    // Token: 0x060004D7 RID: 1239 RVA: 0x0002E708 File Offset: 0x0002C908
    ...
    // Token: 0x060004D8 RID: 1240 RVA: 0x0002E784 File Offset: 0x0002C984
    ...
    // Token: 0x060004D9 RID: 1241 RVA: 0x0002E800 File Offset: 0x0002CA00
    ...
    // Token: 0x060004DA RID: 1242 RVA: 0x0002E87C File Offset: 0x0002CA7C
    ...
    // Token: 0x060004DB RID: 1243 RVA: 0x0002E8F8 File Offset: 0x0002CAF8
    ...
    // Token: 0x060004DC RID: 1244 RVA: 0x0002E974 File Offset: 0x0002CB74
    ...
    // Token: 0x060004DD RID: 1245 RVA: 0x0002E9F0 File Offset: 0x0002CBF0
    ...
    // Token: 0x060004DE RID: 1246 RVA: 0x0002EA6C File Offset: 0x0002CC6C
    ...
    // Token: 0x060004DF RID: 1247 RVA: 0x0002EAE0 File Offset: 0x0002CCE0
    ...
    // Token: 0x060004E0 RID: 1248 RVA: 0x0002EB5C File Offset: 0x0002CD5C
    ...
    // Token: 0x060004E1 RID: 1249 RVA: 0x0002EBD8 File Offset: 0x0002CDD8
    ...
    // Token: 0x060004E3 RID: 1251 RVA: 0x0002ECD0 File Offset: 0x0002CED0
    ...
    // Token: 0x060004E4 RID: 1252 RVA: 0x0002ED44 File Offset: 0x0002CF44
    ...
    // Token: 0x060004E5 RID: 1253 RVA: 0x0002EDC0 File Offset: 0x0002CFC0
    ...
    // Token: 0x060004E6 RID: 1254 RVA: 0x0002EE3C File Offset: 0x0002D03C
    ...
    // Token: 0x060004E7 RID: 1255 RVA: 0x0002EEB8 File Offset: 0x0002D0B8
    ...
    // Token: 0x060004E8 RID: 1256 RVA: 0x0002EF34 File Offset: 0x0002D134
    ...
    // Token: 0x060004E9 RID: 1257 RVA: 0x0002EFAC File Offset: 0x0002D1AC
    ...
    // Token: 0x060004EA RID: 1258 RVA: 0x0002F028 File Offset: 0x0002D228
    ...
    // Token: 0x060004EB RID: 1259 RVA: 0x0002F0B0 File Offset: 0x0002D2B0
    ...
    // Token: 0x060004EC RID: 1260 RVA: 0x0002F138 File Offset: 0x0002D338
    ...
    // Token: 0x060004ED RID: 1261 RVA: 0x0002F1B4 File Offset: 0x0002D3B4
    ...
    // Token: 0x060004EE RID: 1262 RVA: 0x0002F230 File Offset: 0x0002D430
    ...
    // Token: 0x060004EF RID: 1263 RVA: 0x0002F2B8 File Offset: 0x0002D4B8
    ...
    // Token: 0x060004F0 RID: 1264 RVA: 0x0002F338 File Offset: 0x0002D538
    ...
    // Token: 0x060004F1 RID: 1265 RVA: 0x0002F3B8 File Offset: 0x0002D5B8
    ...
    // Token: 0x060004F2 RID: 1266 RVA: 0x0002F434 File Offset: 0x0002D634
    ...
    // Token: 0x060004F3 RID: 1267 RVA: 0x0002F4B0 File Offset: 0x0002D6B0
    ...
    // Token: 0x060004F4 RID: 1268 RVA: 0x0002F52C File Offset: 0x0002D72C
    ...
    // Token: 0x060004F5 RID: 1269 RVA: 0x0002F5A8 File Offset: 0x0002D7A8
    ...
    // Token: 0x060004F6 RID: 1270 RVA: 0x0002F630 File Offset: 0x0002D830
    ...
    // Token: 0x060004F7 RID: 1271 RVA: 0x0002F6B8 File Offset: 0x0002D8B8
    ...
    // Token: 0x060004F8 RID: 1272 RVA: 0x0002F740 File Offset: 0x0002D940
    ...
    // Token: 0x060004F9 RID: 1273 RVA: 0x0002F7C8 File Offset: 0x0002D9C8
    ...
    // Token: 0x060004FA RID: 1274 RVA: 0x0002F850 File Offset: 0x0002DA50
    ...
    // Token: 0x060004FB RID: 1275 RVA: 0x0002F8D8 File Offset: 0x0002DAD8
    ...
    // Token: 0x060004FC RID: 1276 RVA: 0x0002F950 File Offset: 0x0002DB50
    ...
    // Token: 0x060004FD RID: 1277 RVA: 0x0002F9CC File Offset: 0x0002DBCC
    ...
    // Token: 0x060004FE RID: 1278 RVA: 0x0002FA54 File Offset: 0x0002DC54
    ...
    // Token: 0x060004FF RID: 1279 RVA: 0x0002FAD0 File Offset: 0x0002DCD0
    ...
    // Token: 0x06000500 RID: 1280 RVA: 0x0002FB80 File Offset: 0x0002DD80
    ...
    // Token: 0x06000501 RID: 1281 RVA: 0x0002FBF8 File Offset: 0x0002DDF8
    ...
    // Token: 0x06000502 RID: 1282 RVA: 0x0002FC78 File Offset: 0x0002DE78
    public CPUIDSDK()
    {
    }

    // Token: 0x06000503 RID: 1283 RVA: 0x0002FC97 File Offset: 0x0002DE97
    ...
    protected const string szDllName = "..\\..\\..\\..\\..\\bin\\cpuidsdk64.dll";
